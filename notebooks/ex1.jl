...
with $f(\ldots)$ being defined differently depending on $\gamma \in$ `[true,false]`. In particular, if $\gamma=$`true`, then $f(a,b,m)=(a + b)m$, else $f(a,b,m)=a + bm$.
